  ...
  head: () => ({
    meta: [
      { charSet: "utf-8" },
      {
        ...
        content: "x__b0BGaBTFzVnj4_lsv6mWm7AZD01LxXEqMXeb6m9U",
      },
      {
        name: "google-site-verification",
        content: "0PXkV-v50gsnUZYmbPB1Zl-NwOL8yB8eTe9y0JgFq6w",
      },
      {
        name: "viewport",
          ...
          "@graph": [
            {
              ...
              inLanguage: "en",
              publisher: { "@id": "https://indianpanchang.com/#organization" },
            },
            {
              "@type": "Organization",
              "@id": "https://indianpanchang.com/#organization",
              name: "Panchāṅga",
