...
// Redirect / noindex host policy lives in src/lib/seo/host-policy.ts (unit-tested
// in host-policy.test.ts and mirrored by scripts/check-canonical.mjs on the live site).
